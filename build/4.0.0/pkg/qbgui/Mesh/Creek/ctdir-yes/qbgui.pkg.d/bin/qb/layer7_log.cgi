...
print qq (<td align="center" width="100" style="white-space: nowrap;">Application</td>);
...
my @all_layer7=("LAYER7");

foreach my $Target_layer7 ( @all_layer7 )
{
    my $all_layer7_log=`/usr/local/apache/qb/setuid/run grep -r $Target_layer7 /var/log/iptables_layer7.log | awk '{print \$1,\$2,\$3,\$6,\$10,\$11}'`;
