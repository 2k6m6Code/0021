...
#print qq (<a name="noquery">Unit : </a><select id="ip_unit" name="noquery"><option value="all">ALL</option></select>&nbsp;&nbsp;);
print qq ($qblang[774] : <input id="ip_search" value="">);
print qq (</td></tr>);

print qq (<tr><td class="body" align="center">);

print qq (<a name="noquery">$qblang[166] : </a><select id="protocol" name="noquery">);
print qq (<option value="all">ALL</option>);
print qq (</select>&nbsp;&nbsp;);

print qq (<a name="noquery">$qblang[777] : </a><select id="order" name="noquery">);
print qq (<option value="-s srcip/bytes">Bytes</option>);
print qq (<option value="-s srcip/flows">Flows</option>);
print qq (<option value="-s srcip/packets">Packets</option>);
print qq (</select>&nbsp;&nbsp;);
...
{    
    ...
    // } 
     ...
     var limit=\$("#order").val();
     \$.get(url,{time:time,ip:ip,limit:limit,top:top,symd:start},function fno(data){
	\$("#table").html(data);
