...
#print qq (<button  onclick="parent.mainFrame.location='zone2.cgi?viewpoint=dmz'" hidefocus="true" class="menu">Subnet on DMZ</button>);
...
print qq(<form name="zoneform" method="post" action="zone2.cgi">);
