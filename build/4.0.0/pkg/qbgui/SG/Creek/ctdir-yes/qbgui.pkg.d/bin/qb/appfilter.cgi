...
{
    print qq (<br><font class="bigtitle" align="center" >$qblang[189]<font> );
}
...
my $frameSource='editinirule.cgi'.'?'.'viewpoint=app&amp;showqos='.$action{showqos};
#my $frameSource='editapprule.cgi\?viewpoint=nat';
...
print qq (<hr size=1>);
my $frameSource='iniroute.cgi'.'?'.'viewpoint=app&amp;showqos='.$action{showqos};
